...
zmq::message_t GenericMessage::build_zmq_message(){\
	...
	memcpy((unsigned char*) _exe_msg.data(), (const unsigned char*) this->size_payload_byte, sizeof(unsigned));
	memcpy((unsigned char*) _exe_msg.data(), (const unsigned char*) this->payload.c_str(), this->size_payload_byte);
